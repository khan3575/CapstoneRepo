...
BASE_DIR = Path("/mnt/bigdata/capstone/brats_gnn_segmentation")
OUTPUT_DIR = BASE_DIR / "research_results" / "baseline_comparison"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# Load benchmark data
benchmark_file = BASE_DIR / "research_results" / "speed_benchmark" / "benchmark_results.json"
