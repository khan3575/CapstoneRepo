...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/results/cv_dice_per_fold.png}
\caption{Cross-Validation Dice Scores Across 5 Folds.}
\label{fig:cv_dice}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{image/results/cv_boxplots.png}
\caption{Cross-Validation Performance Distribution (2×2 Grid Layout).}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{image/results/cv_training_curves.png}
\caption{Training Dynamics Across 5-Fold Cross-Validation.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{image/results/metrics_distribution.png}
\caption{Distribution of Key Evaluation Metrics Across 5 Cross-Validation Folds. Boxplots show Dice coefficient, accuracy, sensitivity, and specificity with tight inter-quartile ranges, confirming low inter-fold variance and stable model generalisation.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{image/results/statistical_analysis.png}
\caption{Statistical Analysis of Ensemble vs.\ Individual Model Performance. Comparison of Dice coefficient distributions between single fold models and the 5-model soft-voting ensemble, demonstrating the variance-reduction benefit of model aggregation.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{image/results/performance.png}
\caption{Efficiency--Accuracy Comparison: GraphSAGE GNN vs.\ 3D U-Net Baseline. Bar charts comparing inference time, parameter count, GPU memory, and Dice coefficient, illustrating the GNN's substantial computational advantages while maintaining competitive segmentation accuracy.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{image/results/BraTS2021_00501_slice149.png}
\caption{Qualitative Segmentation Example 1 (Patient BraTS2021\_00501, Slice 149).}
\label{fig:qual1}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{image/results/BraTS2021_00491_slice086.png}
\caption{Qualitative Segmentation Example 2 (Patient BraTS2021\_00491, Slice 86).}
\label{fig:qual2}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{image/results/BraTS2021_00559_slice105.png}
\caption{Qualitative Segmentation Example 3 (Patient BraTS2021\_00559, Slice 105).}
\label{fig:qual3}
\end{figure}
