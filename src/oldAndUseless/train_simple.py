# src/train_simple.py - Simplified GNN Training Script
import os
import torch
...
from train import TumorSegmentationGNN
...
def main():
    parser = argparse.ArgumentParser(description='Train BraTS GNN (Simplified)')
    ...
    model = TumorSegmentationGNN(
        ...
        use_consistency=False  # Disable complex loss for now
    ).to(device)
