...
\begin{itemize}
    \item Stratified 5-fold cross-validation with patient-level splits: 720 train / 80 validation / 200 fold-test per fold, drawn from a 1,000-patient CV pool; a strictly isolated 251-patient held-out set was reserved exclusively for final ensemble evaluation
    \item Systematic ablation studies: depth (5 vs.\ 6 layers), width (256 vs.\ 512 hidden dim), architecture (GraphSAGE vs.\ GAT)
...
\begin{itemize}
    ...
    \item \textbf{Ablation Study:} Systematic depth/width/architecture evaluation confirming 5-layer 256-dim GraphSAGE as Pareto-optimal design
    ...
    \item \textbf{Performance Demonstration:} CNN-competitive accuracy (91.41\%) with 6.9$\times$ speedup, 155$\times$ parameter reduction
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Energy Sustainability:} 155$\times$ smaller models reduce carbon footprint at scale
